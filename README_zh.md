...
| 不确定性不等式 ↓ | AlphaEvolve `0.352099104423` · LoongFlow `0.352099104422`<br>**LLM4AD `0.352099104419`** · Δ `+2.68e-12` | [代码](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/solve.py) · [经验](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/experiences/README.md) · [结果](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/result.json) |
| 第二自相关不等式 ↑ | AlphaEvolve `0.8962799442` · LoongFlow `0.9027021077`<br>**LLM4AD `0.9053043553`** · Δ `+0.00260225` | [代码](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/solve.py) · [经验](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/experiences/README.md) · [结果](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/result.json) |
