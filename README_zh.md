...
新增的 [AlphaEvolve 数学基准套件](examples/applications/alphaevolve_math_benchmark/README.md) 将 11 个具有挑战性的几何、组合与不等式问题纳入统一的大模型驱动进化流程。多样岛屿遗传算法让不同岛屿分别保留有效机制、规避已知错误并探索独立解法，同时通过长期记忆持续复用搜索经验。下表展示目前优于 LoongFlow 公开值的成果，并直接提供演化得到的最佳实现及记忆系统保留的全部有效优秀经验卡片。

| 案例 | 方向 | AlphaEvolve | LoongFlow | LLM4AD | 最佳实现 | 演化经验集 |
| --- | --- | ---: | ---: | ---: | --- | --- |
| 单位正方形内 26 圆 | 越高越好 | `2.6358627564136983` | `2.6359829624734026` | **2.635983083325037** | [solve.py](examples/applications/alphaevolve_math_benchmark/circle_packing/results/best/solve.py) | [记忆卡片集](examples/applications/alphaevolve_math_benchmark/circle_packing/results/best/experiences/README.md) |
| 周长为 4 的矩形内 21 圆 | 越高越好 | `2.3658321334167627` | `2.365832229500823` | **2.365832375700835** | [solve.py](examples/applications/alphaevolve_math_benchmark/circle_rectangle/results/best/solve.py) | [记忆卡片集](examples/applications/alphaevolve_math_benchmark/circle_rectangle/results/best/experiences/README.md) |
| 正六边形内 11 个单位正六边形 | 越低越好 | `3.930092` | `3.928906855463712` | **3.92468841680981** | [solve.py](examples/applications/alphaevolve_math_benchmark/hexagon_packing/results/best/solve.py) | [记忆卡片集](examples/applications/alphaevolve_math_benchmark/hexagon_packing/results/best/experiences/README.md) |
| 16 点最大/最小距离比 | 越低越好 | `12.88926611203463` | `12.889243547212832` | **12.889229907694045** | [solve.py](examples/applications/alphaevolve_math_benchmark/max_min_distance_ratio/results/best/solve.py) | [记忆卡片集](examples/applications/alphaevolve_math_benchmark/max_min_distance_ratio/results/best/experiences/README.md) |
| 不确定性不等式 | 越低越好 | `0.35209910442252773` | `0.352099104421844` | **0.35209910441916187** | [solve.py](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/solve.py) | [记忆卡片集](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/experiences/README.md) |
| 第二自相关不等式 | 越高越好 | `0.8962799441554083` | `0.9027021077220739` | **0.9053043552878318** | [solve.py](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/solve.py) | [记忆卡片集](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/experiences/README.md) |
| 第一自相关不等式 | 越低越好 | `1.5052939684401607` | `1.509527314861778` | **1.507459811737381** | [solve.py](examples/applications/alphaevolve_math_benchmark/first_autocorrelation/results/best/solve.py) | [记忆卡片集](examples/applications/alphaevolve_math_benchmark/first_autocorrelation/results/best/experiences/README.md) |
