...
| Uncertainty inequality ↓ | AlphaEvolve `0.352099104423` · LoongFlow `0.352099104422`<br>**LLM4AD `0.352099104419`** · Δ `+2.68e-12` | [Code](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/solve.py) · [Experiences](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/experiences/README.md) · [Result](examples/applications/alphaevolve_math_benchmark/uncertainty_inequality/results/best/result.json) |
| Second autocorrelation inequality ↑ | AlphaEvolve `0.8962799442` · LoongFlow `0.9027021077`<br>**LLM4AD `0.9053043553`** · Δ `+0.00260225` | [Code](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/solve.py) · [Experiences](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/experiences/README.md) · [Result](examples/applications/alphaevolve_math_benchmark/second_autocorrelation/results/best/result.json) |
