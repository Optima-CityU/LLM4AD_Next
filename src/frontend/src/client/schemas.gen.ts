...
export const BuiltinProviderQuotaResponseSchema = {
    properties: {
        available: {
            type: 'boolean',
            title: 'Available',
    ...
    type: 'object',
    title: 'BuiltinProviderQuotaResponse',
    description: '内置供应商额度信息响应。'
} as const;
...
export const EmbeddingProviderResponseSchema = {
    ...
    type: 'object',
    required: ['id', 'created_time', 'updated_time', 'user_id', 'name', 'type', 'api_key', 'auth_token', 'base_url', 'mode', 'model', 'dim', 'timeout', 'embedding_func_max_async', 'text_type', 'text_base_url', 'text_api_key', 'text_auth_token', 'text_model', 'text_task', 'code_type', 'code_base_url', 'code_api_key', 'code_auth_token', 'code_model', 'code_task', 'is_builtin', 'visible_to_all'],
...
export const LiteLLMUserQuotaItemSchema = {
    properties: {
        user_id: {
            anyOf: [
                {
    ...
    type: 'object',
    title: 'LiteLLMUserQuotaItem',
    description: 'LiteLLM 用户额度列表项。'
} as const;

export const LiteLLMUserQuotaListResponseSchema = {
    properties: {
        available: {
            type: 'boolean',
            title: 'Available',
        ...
        items: {
            items: {
                '$ref': '#/components/schemas/LiteLLMUserQuotaItem'
            },
            type: 'array',
            title: 'Items',
            default: []
    ...
    type: 'object',
    title: 'LiteLLMUserQuotaListResponse',
    description: 'LiteLLM 用户额度列表响应。'
} as const;
