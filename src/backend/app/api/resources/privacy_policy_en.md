...
- The website uses our self-hosted Plausible Community Edition instance for visitor analytics, only to understand site traffic and improve the user experience. The analytics are not used for commercial purposes, are not associated with account identity, and are not used to identify specific individuals.
- The repository's default frontend does not bundle third-party advertising, cross-site tracking, or error-tracking scripts such as Google Analytics, Sentry, or Baidu Tongji.
...
- Visitor analytics: aggregate statistics generated by our self-hosted Plausible Community Edition instance, such as page views, referrers, device type, browser type, operating system type, and country or region.
...
- Understand usage of the public website and documentation pages to improve content organization and user experience.
- Guard against malicious requests, crawler abuse, attacks, or other behaviors affecting service availability.

Plausible analytics data is processed and displayed only in our self-hosted Community Edition service. It is not associated with user accounts, task data, API Keys, uploaded files, or other identity information, and is not used for advertising, profiling, or commercial monetization.
...
We do not use any third-party advertising Cookies, cross-site tracking Cookies, or marketing tracking pixels. Visitor analytics through our self-hosted Plausible Community Edition instance does not rely on Cookies used to identify individuals and is not tied to login identity. You can clear or disable Cookies through your browser settings; after disabling them, some preference settings may not be retained, but this does not affect documentation browsing or code downloads.
