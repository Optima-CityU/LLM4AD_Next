...
def _memory_columns() -> list[sa.Column]:
    return [
        ...
        sa.Column("include_user_memory", sa.Boolean(), nullable=False, server_default="true"),
        sa.Column("include_project_memory", sa.Boolean(), nullable=False, server_default="true"),
        sa.Column("include_task_memory", sa.Boolean(), nullable=False, server_default="true"),
        sa.Column("user_memory_limit", sa.Integer(), nullable=False, server_default="5"),
        sa.Column("project_memory_limit", sa.Integer(), nullable=False, server_default="5"),
        ...
        sa.Column("mindmemos_score_threshold", sa.Float(), nullable=True),
